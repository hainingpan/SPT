...
if __name__=="__main__":
    ...
    eta_Born_list,MI_Born_list,LN_Born_list=run(args.es,per,args.L,args.Bp,args.type)
    if rank==0:
    ...
    if rank==0:
        with open('MI_LN_Born_es{}_pt{}_Ap{}_{}.pickle'.format(args.es,args.pt,args.Bp*'Bp',args.type),'wb') as f:
